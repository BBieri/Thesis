...
My tentative research question can be stated as follows:
...
on technological innovation. However, there exist two complementary strains of
literature in political science and innovation economics that could be
bridged by this thesis. The political science part of the literature
...
environmental agreements thereby reducing its complexity and extracting 
centrality
measures from this one-mode projection for each country in yearly averages.
...
fisheries regulation as relevant to their R&D decisions.
...
environmental and knowledge externality. This leads 
...
As hinted in the litterature review above, the methodology will take the form
...
Below, are descriptive snapshots of the International Environmental 
Agreements Database and the [Ecolex](https://www.ecolex.org/) databases for
1980.
Each observation in this dataset links a country to a treaty and gives
additional information about the latter such as the nature of the treaty
...
Alternative data could be sourced from PATSTAT directly if needed.
...
is still private but I can grant you or my potential second reader access
