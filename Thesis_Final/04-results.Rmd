...
environmental patent share regressions. All regressions have been estimated
with Ordinary Least Squares and include country and time fixed effects.
...
\end{adjustbox}
\par \raggedright
\footnotesize{Newey West corrected standard errors. * significant 10\%, ** significant 5\%, *** significant 1\%.}
\par
...
identical than under the full sample.
