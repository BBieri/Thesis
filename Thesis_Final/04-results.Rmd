...
(BERD) and triadic patent counts respectively. We complemented the analysis by
...
specifications. Let us begin by analyzing the innovation output models e.g.
...
is therefore required to better understand these results^[We were unsuccessful
in replicating the results of @martinez-zarzosoDoesEnvironmentalPolicy2019
due to data availiability constraints of their version of the TFP index.].
...
we cannot make any inferential claim on the nature of the relationship between
